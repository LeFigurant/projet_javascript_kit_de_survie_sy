...
prof1.initProfesseur("sensei1", "siesnes1", [17, 11, 1998],"monmel1@wanadoo.fr");
prof1.decrire();

var prof2 = Object.create(Professeur);
prof2.initProfesseur("sensei2", "siesnes2", [18, 11, 1998],"monmel2@wanadoo.fr");
prof2.decrire();

/*
Oui ces nouveaux attributs sont défini dans professeur car professeur possédent tous les attributs d’une Personne
*/